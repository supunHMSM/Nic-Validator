            ...
            <Card className="dashboard-card shadow-sm">
              <Card.Body>
                ...
                <div className="d-flex justify-content-center mt-4">
                  <Button variant="outline-primary" onClick={() => handleDownload('pdf')} className="me-2">Download PDF</Button>
                  <Button variant="outline-success" onClick={() => handleDownload('csv')} className="me-2">Download CSV</Button>
                  <Button variant="outline-info" onClick={() => handleDownload('excel')}>Download Excel</Button>
                </div>
